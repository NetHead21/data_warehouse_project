...
## Overview
The Gold Layer is the business-level data representation, structured to support analytical and reporting use cases. It consists of **dimension views** and **fact views** built on top of the cleaned and transformed silver layer.

---

### 1. `gold.dim_customers`
- **Purpose:** Stores customer details enriched with demographic and geographic data, integrating CRM and ERP source systems.
- **Columns:**
...
| create_date     | DATE         | The date when the customer record was originally created in the source system.                       |

---

### 2. `gold.dim_products`
- **Purpose:** Provides information about the products and their attributes, including category and product line details.
- **Columns:**
...
| product_number  | VARCHAR(50)    | A structured alphanumeric code representing the product, used for categorization or inventory.       |
...
| cost            | NUMERIC(10,2)  | The cost or base price of the product, measured in monetary units.                                   |
...
### 3. `gold.fact_sales`
- **Purpose:** Stores transactional sales data for analytical purposes, linking customers and products via surrogate keys.
- **Columns:**
